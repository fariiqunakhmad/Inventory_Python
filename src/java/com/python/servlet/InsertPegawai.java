 ...
 */
@WebServlet(name = "InsertPegawai", urlPatterns = {"/insertpegawai"})
public class InsertPegawai extends HttpServlet {
...
Pegawai pegawai = new Pegawai();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            pegawaiq.simpanPegawai(pegawai);
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertPegawai</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertPegawai at " + request.getContextPath() + "</h1>");
