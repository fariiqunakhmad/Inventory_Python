 ...
 */
@WebServlet(name = "DeleteJenisProduk", urlPatterns = {"/deletejenisProduk"})
public class DeleteJenisProduk extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            jenisProdukq.deleteJenisProduk(request.getParameter("idjenisProduk"));
