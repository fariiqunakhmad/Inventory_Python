 ...
 */
@WebServlet(name = "DeleteDPBB", urlPatterns = {"/deleteDPBB"})
public class DeleteDPBB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String report;
        String idPengambilanBB=request.getParameter("idPengambilanBB");
        int idProduk=Integer.parseInt(request.getParameter("idProduk")), idJenisProduk=Integer.parseInt(request.getParameter("idJenisProduk"));
            
        try{
            DetailTargetProdukQuery detailTargetProdukq = new DetailTargetProdukQuery(dbc.getCon());
            
            detailTargetProdukq.deleteDetailTargetProduk(idPengambilanBB, idProduk, idJenisProduk );
        ...
        try {
            ...
            out.print(idPengambilanBB+", "+idProduk+", "+idJenisProduk );
            out.println("</body>");
            out.println("</html>");
            response.sendRedirect("daftardetailpbb.jsp?idpengambilanbb="+idPengambilanBB);
        } finally {            
            out.close();
        }
    }
