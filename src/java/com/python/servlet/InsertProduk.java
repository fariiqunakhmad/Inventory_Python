 ...
 */
@WebServlet(name = "InsertProduk", urlPatterns = {"/insertproduk"})
public class InsertProduk extends HttpServlet {
...
//            out.println(request.getParameter("txtstockmin"));
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertProduk</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertProduk at " + request.getContextPath() + "</h1>");
