 ...
 */
@WebServlet(name = "InsertDPBB", urlPatterns = {"/insertDPBB"})
public class InsertDPBB extends HttpServlet {
...
DetailTargetProduk detailTargetProduk = new DetailTargetProduk();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            detailTargetProdukq.simpanDetailTargetProduk(detailTargetProduk);
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertDetailTargetProduk</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertDetailTargetProduk at " + request.getContextPath() + "</h1>");
            out.println("<br><a href='index.jsp'> Home </a>");
            out.println("<br><a href='daftardetailTargetProduk.jsp'> Daftar DetailTargetProduk</a>");
            out.print(detailTargetProduk.getIdPengambilanBB()+""+detailTargetProduk.getIdProduk()+","+detailTargetProduk.getIdJenisProduk()+","+detailTargetProduk.getQtyTargetProduk()+","+detailTargetProduk.getSatuanProdukTarget());
            out.println("</body>");
            out.println("</html>");
