 ...
 */
@WebServlet(name = "DeleteBahanBaku", urlPatterns = {"/deletebahanbaku"})
public class DeleteBahanBaku extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            bahanBakuq.deleteBahanBaku(request.getParameter("idbahanBaku"));
