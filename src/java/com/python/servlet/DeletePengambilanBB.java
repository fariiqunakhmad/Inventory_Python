 ...
 */
@WebServlet(name = "DeletePengambilanBB", urlPatterns = {"/deletepengambilanbb"})
public class DeletePengambilanBB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            pengambilanBBq.deletePengambilanBB(request.getParameter("idpengambilanbb"));
