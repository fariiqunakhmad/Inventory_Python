 ...
 */
@WebServlet(name = "InsertJenisProduk", urlPatterns = {"/insertjenisProduk"})
public class InsertJenisProduk extends HttpServlet {
...
JenisProduk jenisProduk = new JenisProduk();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            jenisProdukq.simpanJenisProduk(jenisProduk);
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertJenisProduk</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertJenisProduk at " + request.getContextPath() + "</h1>");
