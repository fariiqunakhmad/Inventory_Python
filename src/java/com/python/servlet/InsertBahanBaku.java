 ...
 */
@WebServlet(name = "InsertBahanBaku", urlPatterns = {"/insertbahanbaku"})
public class InsertBahanBaku extends HttpServlet {
...
BahanBaku bahanBaku = new BahanBaku();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            bahanBakuq.simpanBahanBaku(bahanBaku);
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertBahanBaku</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertBahanBaku at " + request.getContextPath() + "</h1>");
