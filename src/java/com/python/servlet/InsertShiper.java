 ...
 */
@WebServlet(name = "InsertShiper", urlPatterns = {"/insertshiper"})
public class InsertShiper extends HttpServlet {
...
Shiper shiper = new Shiper();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            shiperq.simpanShiper(shiper);
            out.println("Insert Sukses");
            out.println(shiper.getIdShiper());
            out.println(shiper.getIdKota());
            out.println(shiper.getNamaShiper());
            out.println(shiper.getAlamatShiper());
            out.println(shiper.getTlpShiper());
        } catch (Exception e){
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertShiper</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertShiper at " + request.getContextPath() + "</h1>");
